...
def page_3():
    ...
    **Interprétation :**  
    ...
    st.write("""
    **Interprétation :**  
    Les barplots offrent une visualisation précise des proportions de chaque couleur selon les tranches d'âge. On remarque que la prédilection pour les teintes neutres — gris, noir et blanc — reste dominante dans toutes les catégories d'âge. Par ailleurs, les 18-25 ans achètent significativement moins de voitures que les autres groupes, les personnes plus âgés réalisant environ dix fois plus d'achats.
    """)
